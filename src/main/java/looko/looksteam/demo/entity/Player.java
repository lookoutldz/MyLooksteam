...
public class Player {
    ...
    public void setGameextrainfo(String gameextrainfo) {
        this.gameextrainfo = gameextrainfo == null ? null : gameextrainfo.trim();
    }
    ...
    public void setGameserverip(String gameserverip) {
        this.gameserverip = gameserverip == null ? null : gameserverip.trim();
    }
    ...
    public void setLoccityid(String loccityid) {
        this.loccityid = loccityid == null ? null : loccityid.trim();
    }
